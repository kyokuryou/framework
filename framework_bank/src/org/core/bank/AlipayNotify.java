...
import org.core.bank.alipay.AlipayCore;
import org.core.bank.utils.MD5Util;
 ...
 * 支付宝通知处理类
 */
public class AlipayNotify extends BankNotify {
    ...
    private boolean getSignVeryfy(Map<String, String> Params, String sign) {
        ...
        if ("MD5".equals(signType)) {
            isSign = MD5Util.verify(preSignStr, sign, key, inputCharset);
        }
        return isSign;
    }
