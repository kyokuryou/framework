...
(function ($, window, undefined) {
    ...
    lhgcalendar.fn = lhgcalendar.prototype = {
        ...
        _draw:function (date, day) {
            ...
            for (var i2 = 1; i2 <= curMonth; i2++)
                arrDate.push(i2);

            for (var i3 = 1; i3 <= 42 - curMonth - firstDay; i3++)
                arrDate.push(i3);
        ...
        _addEvent:function () {
            ...
            DOM.ymlist.bind('click', function (evt) {
                ...
                if (target[expando + 'M'] >= 0) {
                    ...
                    var p1 = $('a', DOM.lbox[0])[0][expando + 'Y'];
                    that._drawList(p1 - 12);
                }
                else if (target === DOM.nybar[0]) {
                    var p2 = $('a', DOM.lbox[0])[0][expando + 'Y'];
                    that._drawList(p2 + 12);
                }
