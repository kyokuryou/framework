...
new function (_y) {
    ...
    var Base = _b.call(Object, {
        ...
        ancestorOf: function (a) {
            return _7(this, a)
        }, extend: _b, forEach: function (a, b, c) {
            _5(this, a, b, c)
    ...
    var _p = /\\(\d+)/g, _q = /\\./g, _r = /\(\?[:=!]|\[[^\]]+\]/g, _s = /\(/g, _t = /\$(\d+)/, _u = /^\$\d+$/;
    var RegGrp = Collection.extend({
        constructor: function (a, b) {
            this.base(a);
            this.ignoreCase = !!b
        }, ignoreCase: false, exec: function (g, i) {
            g += "";
            var h = this, j = this[_0];
    ...
    var Array2 = _6(Array, Array, "concat,join,pop,push,reverse,shift,slice,sort,splice,unshift", Enumerable, {
        ...
        }, forEach: _e, indexOf: function (a, b, c) {
            var e = a.length;
            if (c == null) {
                c = 0
            } else if (c < 0) {
    ...
    var String2 = _6(String, function (a) {
        ...
        csv: csv, format: format, rescape: rescape, trim: trim
    });
...
function packerBase(code) {
    var p = new Packer;
    return p.pack(code, 1, 0);
}