...
(function (window, undefined) {
    ...
    (function (window, undefined) {
        ...
        // Easily-parseable/retrievable ID or TAG or CLASS selectors
            ...
            matchExpr = {
                ...
                "CHILD": new RegExp("^:(only|nth|first|last)-child(?:\\(" + whitespace + "*(even|odd|(([+-]|)(\\d*)n|)" + whitespace + "*(?:([+-]|)" + whitespace + "*(\\d+)|))" + whitespace + "*\\)|)", "i"), // For use in libraries implementing .is()
    ...
    jQuery.fn.load = function (url, params, callback) {
        ...
        jQuery.ajax({
            ...
            type: type, dataType: "html", data: params, complete: function (jqXHR, status) {
                if (callback) {
    ...
    function Animation(elem, properties, options) {
        ...
        jQuery.fx.timer(jQuery.extend(tick, {
            anim: animation, queue: animation.opts.queue, elem: elem
        }));
